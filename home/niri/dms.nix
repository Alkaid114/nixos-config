...
in
{
  ...
  xdg.configFile = {
    "DankMaterialShell/settings".source = ../dotfiles/DankMaterialShell/settings.json;
  };
  # xdg.configFile."DankMaterialShell/settings.json".text = # json
  #   ''
  #     {
  #       "currentThemeName": "custom",
  #       "customThemeFile": "/home/${username}/.config/DankMaterialShell/stylix-colors.json",
